...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void SelectByColorId(int colorId)
        {
            ...
            {
                Console.WriteLine(car.Id + " " + car.BrandName + " " + car.ModelYear + " " + car.ColorName + " " + car.DailyPrice + "TL Günlük " + car.Description);
            }
        }
        ...
        {
            CarManager carManager = new CarManager(new EfCarDal());
            foreach (var car in carManager.GetAllCar().Data)
            {
        ...
        private static void CarDelete()
        {
            ...
            int id = int.Parse(Console.ReadLine());
            carManager.DeleteCar(new Car { Id = id });
        }
        ...
        private static void CarByBrandId()
        {
            ...
            {
                Console.WriteLine("Car Description" + car.Description + "Brand Id: " + car.BrandId + "Model Year: " +
                                  car.ModelYear + "Gunluk Ucreti" + car.DailyPrice);
            }
        }
        ...
        private static void ListRentalByCustomerId(int customerId)
        {
            ...
            {
                Console.WriteLine(rent.Id + " " + rent.ModelYear + " " + rent.BrandName + " " + rent.Description + " " + "Kiralanan Firma: " + rent.CompanyName);
            }
        }
        ...
        //    //carManager.AddCar(new Car{Description = "Deneme"});
        ...
        //    //////List all cars
        //    ////var getAllresult = carManager.GetAllCar();
        ...
        //    var getAllresult2 = carManager2.GetCarDetails();

        //    foreach (var car2 in getAllresult2.Data)
        //    {
        //        Console.WriteLine($"{car2.Description} - {car2.BrandName}- {car2.ColorName}");
        //    }
        //}
    }
}